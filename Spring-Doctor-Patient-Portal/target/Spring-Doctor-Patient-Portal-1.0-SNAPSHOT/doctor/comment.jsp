						...
						<form class="row g-3" action="../updateStatus" method="post">
							...
							<div class="col-md-6">
								<label class="form-label">Full Name</label> <input
									...
									class="form-control" readonly value="value="${appointment.fullName}">
							...
							<input type="hidden" name="doctorId" value="${appointment.doctorId}" class="form-control">
