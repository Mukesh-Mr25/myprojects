...
<body>
	...
	<div class="container-fluid p-3">
		<div class="row">
						...
						<form action="../updateDoctor" method="post">
							<div class="mb-3">
								<label class="form-label">Full Name</label> <input
									...
									class="form-control" value="${doctor.fullName}">

							</div>
							<div class="mb-3">
								<label class="form-label">Date of Birth</label> <input
									name="dateOfBirth" type="date" placeholder="Enter DOB"
									class="form-control" value="${doctor.dateOfBirth}">
            ...
            <option value="${doctor.specialist}" selected>${doctor.specialist}</option>
                ...
                <option value="${specialist.name}">${specialist.name}</option>
							...
							<div class="mb-3">
								<label class="form-label">Password</label> <input
									...
									class="form-control" value="${doctor.password}">
							</div>
