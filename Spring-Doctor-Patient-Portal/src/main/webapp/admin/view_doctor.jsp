				...
				<div class="card my-card">
					<div class="card-body">
						...
						<table class="table table-striped">
							...
							<tbody>
                                                            <c:forEach var="doctor" items="${doctorLst}">
                                                               <tr>
									...
									<td><a class="btn btn-sm btn-primary"
										href="edit_doctor.jsp?id=${doctor.id}">Edit</a></td>
									<td><a class="btn btn-sm btn-danger" href="../deleteDoctor?id=${doctor.id}">Delete</a></td>
